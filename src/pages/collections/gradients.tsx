    ...
    <>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/50 max-w-2xl mx-auto mb-6">
              CSS gradient backgrounds — aurora, mesh, holographic, conic, noise
              texture and more.
            </p>
            ...
            {items.map((item, i) => (
              ...
              >
                <div
                  ...
                  style={item.previewStyle as React.CSSProperties}
                />
                <div className="px-5 py-4 border-t border-white/6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-medium bg-white/5 text-white/40 border border-white/6 uppercase tracking-wider">
                      {item.tag}
                    </span>
                    <button
                      onClick={() => setSel(item)}
                    ...
                    <Link
                      ...
                      className="relative z-10 px-3.5 py-1.5 rounded-lg text-[11px] font-semibold bg-[#6C63FF]/10 text-[#a78bfa] border border-[#6C63FF]/20 hover:bg-[#6C63FF]/20 hover:border-[#6C63FF]/40 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer text-center"
                    >
                      Details
                    </Link>
                  </div>
      ...
      <CodeViewerOverlay
        ...
        sections={
          sel
            ? ([
                { label: "CSS", language: "css", code: sel.css },
              ] as CodeSection[])
            : []
        }
      />
