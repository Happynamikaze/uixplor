...
export default function Dashboard() {
  ...
  return (<>
    <PageSEO title="CSS Dashboard Components — Stats Cards, Sidebars, Tables — UIXplor" description={`${items.length} CSS dashboard UI components: KPI stat cards, sidebar navigation, activity feeds, analytics summaries, data tables, admin headers. Copy HTML + CSS instantly.`} path="/collections/dashboard" keywords={['dashboard CSS','stat card CSS','admin UI CSS','data table CSS','sidebar navigation CSS','analytics card CSS']} jsonLd={[{'@context':'https://schema.org','@type':'CollectionPage',name:'CSS Dashboard Components — UIXplor',url:'https://www.uixplor.com/collections/dashboard',numberOfItems:items.length,isPartOf:{'@type':'WebSite',name:'UIXplor',url:'https://www.uixplor.com'}},{'@context':'https://schema.org','@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'Home',item:'https://www.uixplor.com'},{'@type':'ListItem',position:2,name:'Collections',item:'https://www.uixplor.com/collections'},{'@type':'ListItem',position:3,name:'Dashboard',item:'https://www.uixplor.com/collections/dashboard'}]}]}/>
