...
export default function Layouts() {
  ...
  return (<>
    <PageSEO title="CSS Layout Sections — Hero, Pricing, Testimonials, FAQ — UIXplor" description={`${items.length} CSS layout sections: hero banners, feature grids, pricing tables, testimonial cards, CTA sections, stats rows, FAQ accordions, and blog grids. Copy HTML + CSS.`} path="/collections/layouts" keywords={['CSS hero section','pricing table CSS','testimonial CSS','FAQ accordion CSS','CTA section CSS','CSS layout sections','landing page CSS']} jsonLd={[{'@context':'https://schema.org','@type':'CollectionPage',name:'CSS Layout Sections — UIXplor',url:'https://www.uixplor.com/collections/layouts',numberOfItems:items.length,isPartOf:{'@type':'WebSite',name:'UIXplor',url:'https://www.uixplor.com'}},{'@context':'https://schema.org','@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'Home',item:'https://www.uixplor.com'},{'@type':'ListItem',position:2,name:'Collections',item:'https://www.uixplor.com/collections'},{'@type':'ListItem',position:3,name:'Layouts',item:'https://www.uixplor.com/collections/layouts'}]}]}/>
