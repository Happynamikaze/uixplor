...
export default function Navigation() {
  ...
  return (<>
    <PageSEO
      ...
      jsonLd={[{ '@context': 'https://schema.org', '@type': 'CollectionPage', name: 'CSS Navigation Components — UIXplor', url: 'https://www.uixplor.com/collections/navigation', numberOfItems: items.length, isPartOf: { '@type': 'WebSite', name: 'UIXplor', url: 'https://www.uixplor.com' } }, { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.uixplor.com' }, { '@type': 'ListItem', position: 2, name: 'Collections', item: 'https://www.uixplor.com/collections' }, { '@type': 'ListItem', position: 3, name: 'Navigation', item: 'https://www.uixplor.com/collections/navigation' }] }]}
    />
